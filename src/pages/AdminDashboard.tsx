...
export default function AdminDashboard() {
  ...
  const NavLinks = () => {
    ...
    return (
      <nav className="flex-1 overflow-y-auto flex flex-col gap-1 mt-6 mb-4 pr-2 pb-4 scrollbar-thin">
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#06080F] flex flex-col md:flex-row relative transition-colors duration-300">
      {/* Mobile Header */}
      <div className="md:hidden bg-navy dark:bg-[#0F1423] text-white p-4 flex justify-between items-center sticky top-0 z-20 border-b dark:border-[#1E2741]">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside 
              ...
              className="fixed inset-y-0 left-0 w-64 bg-navy dark:bg-[#0F1423] text-white p-6 flex flex-col z-50 md:hidden shadow-xl border-r dark:border-[#1E2741] transition-colors duration-300"
            >
      ...
      {/* Desktop Sidebar */}
      <aside className="w-64 bg-navy dark:bg-[#0F1423] border-r dark:border-[#1E2741] text-white p-6 hidden md:flex flex-col sticky top-0 h-screen transition-colors duration-300">
      ...
      <main className="flex-grow p-4 md:p-8 max-w-5xl mx-auto w-full overflow-x-hidden min-h-screen">
        <Tabs value={activeTab} className="space-y-6">
          ...
          <TabsContent value="home">
            <Card className="dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
              <CardHeader>
          ...
          <TabsContent value="global">
            ...
            <Card className="mt-6 dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
              <CardHeader>
          ...
          <TabsContent value="services">
            ...
            <div className="grid gap-4">
              {services.map(service => (
                <Card key={service.id} className="border-editorial-border dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
          ...
          <TabsContent value="experiences">
            ...
            <div className="grid gap-4">
              {experiences.map(exp => (
                <Card key={exp.id} className="border-editorial-border dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
                  <CardContent className="p-6 grid gap-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
          ...
          <TabsContent value="products">
            ...
            <div className="grid gap-4">
              {products.map(product => (
                <Card key={product.id} className="border-editorial-border dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
                  <CardContent className="p-6 grid gap-4">
          ...
          <TabsContent value="promos">
            ...
            <div className="grid gap-4">
              {promos.map(promo => (
                <Card key={promo.id} className="border-editorial-border dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
                  <CardContent className="p-6 grid gap-4">
                    <div className="flex flex-col md:flex-row gap-6">
                      {/* Image section */}
                      <div className="flex-shrink-0 w-full md:w-48 space-y-2">
          ...
          <TabsContent value="testimonials">
            ...
            <div className="grid gap-4">
              {testimonials.map(testi => (
                <Card key={testi.id} className="border-editorial-border dark:!bg-[#0F1423] dark:!border-[#1E2741] transition-colors duration-300">
                  <CardContent className="p-6 grid gap-4">
                    <div className="flex flex-col md:flex-row gap-6">
                      {/* Image section */}
                      <div className="flex-shrink-0 w-full md:w-48 space-y-2">
